requirejs(['firebase-config'],function(config){
  ...
  `,
        ...
        data:function(){
            return {
                rooms:[
                    {id:"001",name:"PHP",description:"Entusiasta PHP"},
                    {id:"002",name:"Java",description:"Developers experts"},
                    {id:"003",name:"C#",description:"Os cara do C#"},
                    {id:"004",name:"C++",description:"Fissurados pro programacao"},
                    {id:"005",name:"Javascript",description:"Olha a web ai"},
                    {id:"006",name:"Vue.js",description:"Chat dos cara do data-bind"}
                ],
                name:'',
                email:'',
                room:null
